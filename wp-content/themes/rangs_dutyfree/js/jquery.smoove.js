...
(function ($, window, document){
    var up=false, down=true, interval=1500,  intval;
	$("#text5").hide();
        ...
        function smooveIt(direction) {
            for(var i = 0; i < $.fn.smoove.items.length; i++) {
                ...
                if(itemtop < offset) {
                    ...
                    //console.log("inside up:"+interval);
				}
               /*     setInterval(function(){
					...
					//console.log(params); downside
					
					
                    
					var transforms = [],
                        properties = ['completeX','completeY'];
                    ...
                    var transform = '';
                    for(var t in transforms) {
                        transform += t.replace('complete', 'translate') + '(' + transforms[t] + ') ';
                       
                    }
                    if(transform) {
                        $item.css('opacity', 0.9).css(crossBrowser('transform', transform));                      
					...
					down = false;
                    up = true;
                    //console.log("inside down:"+interval);
					}
                }
            }
